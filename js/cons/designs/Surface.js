...
/*                    var material = new THREE.LineBasicMaterial({
                ...
                return {
                    ...
                    getY: getY,
                    getZ: getZ,
                    linearDistR: linearDistR,
                    surfaceDistR_along_azimuth: surfaceDistR_along_azimuth,
                    surfaceDistR_along_polar: surfaceDistR_along_polar,
                    horizontalSurfaceProjection: horizontalSurfaceProjection
                };
            }(aSurfaceSpec, getXgetYgetZ_rad, phiR_estimator));

            Object.freeze(aSurface);
            return aSurface;
        };
