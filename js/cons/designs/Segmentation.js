...
define(
    ...
    function (
        ...
        Segmentation = function ( aSegmentationSpec, aDelimitation, aSurface ) {
            ...
            aSegmentation = function (aSegmentationSpec, aDelimitation, aSurface) {
                var spec = {},
...
/*                linearDistS = function (phiS_start, phiS_end, thetaS_start, thetaS_end) {
 ...
 /*                horizontalSurfaceProjectionS = function(phiS, thetaS) {
                ...
                return {
                    phiR_offset_by_phiR_min: phiR_offset_by_phiR_min,
                    thetaR_offset_by_thetaR_min: thetaR_offset_by_thetaR_min,
                    phiR_from_phiS: phiR_from_phiS,
                    thetaR_from_thetaS: thetaR_from_thetaS,

                    noOfSegments_along_azimuth: noOfSegments_along_azimuth,
                    noOfSegments_along_polar: noOfSegments_along_polar,
                    segment_extent_azimuth: segment_extent_azimuth,
                    segment_extent_polar: segment_extent_polar,
                    getXSEA: getXSEA,
                    getYSEA: getYSEA,
                    getZSEA: getZSEA,
                    getXSES: getXSES,
                    getYSES: getYSES,
                    getZSES: getZSES,
                    linearDistS: linearDistS
                };
            }(aSegmentationSpec, aDelimitation, aSurface);

            Object.freeze(aSegmentation);
            return aSegmentation;
